...
public class Main {
    public static void main(String[] args) {
        ...
        String toFile = "C:\\Users\\johan\\UP\\Project\\UPkod\\utfil.txt";
    ...
    public static void timePrint(String toFile, long t0, long t1) {
        try {
            ...
            Long tRes = t1 - t0;
            String tResString = tRes.toString();

            writer.write(tResString + "\n");
            writer.close();
    ...
    public static double[] readTal1() {
        ...
        try {
            String filePathTal1 = "C:\\Users\\johan\\UP\\Project\\UPkod\\tal1.txt";
            File fileTal1 = new File(filePathTal1);
    ...
    public static String[] readOrd1() {
        ...
        try {
            File fileOrd1 = new File("C:\\Users\\johan\\UP\\Project\\UPkod\\ord1.txt");
